...
const Experience = () => {
    ...
    return (
        <div className="h-full w-full bg-black relative">
            ...
            <div className="flex flex-col w-36 h-auto p-2 _bg-[red] absolute top-1/2 -translate-y-1/2 z-[30] items-center gap-2">
...
const ImageGallery = () => {
    ...
    return (
        <div className="w-full h-full relative">
            <Image src={'/icons/right_1.svg'} width={600} height={600} alt="right" className="w-24 h-24 object-cover absolute top-1/2 -translate-y-1/2 right-10 cursor-pointer" onClick={ImageHandler}
            />

            {index > 0 && (
                <Image src={'/icons/left_1.svg'} width={600} height={600} alt="left" className="w-24 h-24 object-cover absolute top-1/2 -translate-y-1/2 left-20 cursor-pointer z-[31]" onClick={backwardHandler}/>
            )}
