...
const WoodColorOption = ({ title, name, value, active, setActive }) => (
    <div
    ...
    >
        <div className='w-32 h-32 rounded-full shadow shadow-black/20' >
            <Image src={value} height={1024} width={1024} alt={title} className="w-32 h-32 rounded-full shadow shadow-black/20"/>
        </div>
    </div>
);
