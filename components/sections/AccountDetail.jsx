    ...
    <div className="w-full p-3 border border-gray-300 rounded-lg shadow-md">
      ...
      <form className="space-y-3">
        ...
        <div className="flex flex-col">
          ...
          <input type="email" className="w-full lg:h-12 h-10 px-3 border rounded-md bg-[#E5E5E5]" />
        </div>
        ...
        <div className="flex flex-col">
          ...
          <input type="tel" className="w-full lg:h-12 h-10 px-3 border rounded-md bg-[#E5E5E5]" />
        </div>
